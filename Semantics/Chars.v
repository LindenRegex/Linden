...
Section Chars.
  ...
  (* the other direction is directly true *)
  Lemma input_rewind_fwd:
    forall pref, input_rewind (Input [] pref) forward = Input [] pref.
  Proof. intros. simpl. now rewrite app_nil_r, rev_involutive. Qed.
